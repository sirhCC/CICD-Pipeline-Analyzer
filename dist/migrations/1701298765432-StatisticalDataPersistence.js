...
exports.StatisticalDataPersistence1701298765432 = void 0;
const typeorm_1 = require("typeorm");
class StatisticalDataPersistence1701298765432 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.createIndex('statistical_results', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('anomaly_history', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('trend_history', new typeorm_1.TableIndex({
        ...
        await queryRunner.createIndex('statistical_cache', new typeorm_1.TableIndex({
...
exports.StatisticalDataPersistence1701298765432 = StatisticalDataPersistence1701298765432;
//# sourceMappingURL=1701298765432-StatisticalDataPersistence.js.map